<!-- Keywords + SEO -->
<title>FS19 Rogue River - BestFSMods</title>
<meta name="description" content="Download the Rogue River FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Rogue River - BestFSMods">
<meta name="twitter:description" content="Download the Rogue River FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/rogue-river.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Rogue River - BestFSMods">
<meta property="og:description" content="Download the Rogue River FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/rogue-river.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/rogue-river.jpg" alt="Rogue River FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Rogue River Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Rogue River is a forestry only map full of challenging terrain.<br> <br> ChangeLog 1.3.0.0:<br> - Lowered
          bridges
          so the floor is at ground level.<br> - Lowered map brightness.<br> - Removed coyote and industrial sounds.
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: Catalyzer Gaming</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/kt0cswo1og9v/FS19_RogueRiver.zip.html" target="_blank"><button
