...
<head>
  ...
  <?php 
    ...
    $postTitle = 'MAN TGS 18 Bale Transport AutoLoad';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/man-tgs-bale-transport.jpg';
    $postCategory = 'trucks';
    $downloadLink = 'http://modsfile.com/en7q5pk7had9/FS19_MAN_18500Bale.zip.html';
    $postAuthor = 'Bart - NLD Community';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Truck information:
          <br><br>
          Name: MAN TGS 18.500 Bale Transport.
          <br>
          Price: €180.500
          <br>
          Horsepower: 500 PS
          <br>
          Capacity: SquareBale 28
          <br>
          Capacity: RoundBale 40
        </p>
