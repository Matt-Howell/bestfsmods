...
<head>
  ...
  <?php 
    ...
    $postTitle = 'NMC Griffin Semi';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/nmc-griffin-semi.jpg';
    $postCategory = 'trucks';
    $downloadLink = 'http://modsfile.com/ssjkykgo03vw/FS19_NMC_Griffin_Semi_UniversalPassenger.zip.html';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          The Griffin is a semi truck for all your needs. With alot of options in tires and axels aswell as alot of
          design
          options makes it perfect for any use. Tons of options for cab decorations, bullbars and lights to make sure
          its
          the king of the road.<br>
          <br>
          Griffin Truck:<br>
          -Top speed: 83 km/h<br>
