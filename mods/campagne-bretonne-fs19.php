<!-- Keywords + SEO -->
<title>FS19 Campagne Bretonne - BestFSMods</title>
<meta name="description" content="Download the Campagne Bretonne FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Campagne Bretonne - BestFSMods">
<meta name="twitter:description" content="Download the Campagne Bretonne FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/campagne-bretonne.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Campagne Bretonne - BestFSMods">
<meta property="og:description" content="Download the Campagne Bretonne FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/campagne-bretonne.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/campagne-bretonne.jpg" alt="Campagne Bretonne FS19"
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Campagne Bretonne Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          &ndash; This map includes cows, horses and cultures.<br> &ndash; Three farms (Cows) (cultures) (Horses).<br>
          &ndash; Realistic map with everything inspired from real landscape.<br> &ndash; New plough texture.<br>
          &ndash;
          Detailled in every places<br> &ndash; 1 cooperative, 1 selling point for wool and eggs.<br> &ndash; XX fields
          differents (scale and form).<br> &ndash; Updates PDA.<br> &ndash; Some models are created by me.<br> &ndash;
          Forestry,sawmill area included.<br> &ndash; Various custom sounds across the map.<br> &ndash; Multi terrain
          angle
          (pc only)<br> <br> I Hope you all like this map.
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: SoModding</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/e6oxa3m3wgx9/FS19_CampagneBretonne.zip.html" target="_blank"><button
