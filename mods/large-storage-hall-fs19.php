...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Large Storage Hall';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/large-storage-hall.jpg';
    $postCategory = 'buildings';
    $downloadLink = 'http://modsfile.com/mtije95e8way/FS19_largePoleBarn.zip.html';
    $postAuthor = '	gForce_modding';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Large 35m x 55m Pole Barn with Fuel Filling station and Hydraulic Lift to access the MASSIVE storage loft.<br>
          Plenty of lower floor space to store the largest of equipment and enough storage on the second level for
          storing
          smaller<br>
          machines and equipment or large quantities of bales and pallets. The limits are endless!<br>
          -Use switch panel on wall to toggle visibility of dividers.<br>
          Bonus: Fuel is sold at commercial price and is 40% less than standard cost.<br>
          -Seasons Ready-<br>
          Price: 30,420<br>
          ENJOY<br>
          <br>
          Changelog: 1.1.0.0<br>
          -Added Divider Walls with visibility control<br>
          -Added a Red and Blue option<br>
