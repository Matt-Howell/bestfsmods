...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Purbeck Valley Farm';
    $postDesc = 'Download '.$postTitle.' FS 19 map here!';
    $postImg = '/images/mod-images/purbeck-valley-farm.jpg';
    $postCategory = 'maps';
    $downloadLink = 'http://modsfile.com/5ym7ku2ru32x/FS19_Purbeck_Valley_Farm.zip.html';
    $postAuthor = 'Tommx55';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome to Purbeck Valley Farm, based on the area of Dorset south UK, with the view of Corfe Caslte in the
          distance.<br>
          <br>
          - 4 farms, arable/grain, dairy, sheep/chickens, piggery.<br>
          - Custom ground textures<br>
          - Animals are built into the map<br>
          - Multiple sell points, pubs, industrial park<br>
          - 81 fields ranging from large to small, grass/arable<br>
          - Multiple forests, sawmill, large BGA, stock market and a train.<br>
          - Lighting adjustments<br>
          - Seasons Ready<br>
          <br>
          -V1.1<br>
          - Fixed animals not showing in MP/Farm manager mode<br>
          - Visual fixes.<br>
          - Sheep trigger fix<br>
          - Own a second yard<br>
          - Reduced field prices<br>
          - fixed wool and egg spawn<br>
          <br>
          Enjoy
        </p>
