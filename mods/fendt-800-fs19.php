<!-- Keywords + SEO -->
<title>FS19 Fendt 800 S4 - BestFSMods</title>
<meta name="description" content="Download the Fendt 800 S4 FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Fendt 800 S4 - BestFSMods">
<meta name="twitter:description" content="Download the Fendt 800 S4 FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/fendt-800.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Fendt 800 S4 - BestFSMods">
<meta property="og:description" content="Download the Fendt 800 S4 FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/fendt-800.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/fendt-800.jpg" alt="Fendt 800 S4 FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Fendt 800 S4 Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Price: 212000 &euro;<br> Power: 220-280hp<br> Design Color Configurations<br> Animated Doors<br> New Colors
          Rims<br> -Update 1.1.0.0<br> -New Colors Design<br> -Fixed various bugs<br> -New Colors Rims<br> -New
          Details<br>
          -New Tires Configurations<br> -Update 1.2.0.0<br> -New Tires Configurations<br> -New Skin<br> -Fixed various
          bug<br> -Fix interior parts
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: STv-Modding</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/boakc5r2moih/FS19_Fendt800S4.zip.html" target="_blank"><button
