...
<head>
  ...
  <?php 
    ...
    $postTitle = 'MAN TGS 18 Pack';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/man-tgs18.jpg';
    $postCategory = 'trucks';
    $downloadLink = 'http://modsfile.com/vmghc1ribsaj/FS19_manTGS_Pack.zip.html';
    $postAuthor = 'Kasztan18';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          MAN TGS 18 Kipper & Semi<br><br>
          Price: $190000, $150000<br>
          Horsepower: 480 HP<br>
          Capacity: 9310, 17150
        </p>
