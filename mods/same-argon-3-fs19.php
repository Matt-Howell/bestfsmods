<!-- Keywords + SEO -->
<title>FS19 Same Argon 3 - BestFSMods</title>
<meta name="description" content="Download the Same Argon 3 FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Same Argon 3 - BestFSMods">
<meta name="twitter:description" content="Download the Same Argon 3 FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/same-argon.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Same Argon 3 - BestFSMods">
<meta property="og:description" content="Download the Same Argon 3 FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/same-argon.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/same-argon.jpg" alt="Same Argon 3 FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Same Argon 3 Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Same Argon 3 75.<br> <br> -Price: &euro; 20000<br> -Top speed: 35 km 43 km<br> -Engine Configuration: 80 Hp
          105
          Hp<br> -Front Hydraulics<br> -Weights<br> -Weight Carrier<br> -Wheel Color Selection
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: raulycristi1</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/k1e2lszzfc9n/FS19_same_argon3_75.zip.html" target="_blank"><button
