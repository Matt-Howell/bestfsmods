...
<head>
  ...
  <?php 
    ...
    $postTitle = 'NMC Scarok Pack';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/nmc-scarok-pack.jpg';
    $postCategory = 'vehicles';
    $downloadLink = 'http://modsfile.com/gb0bjhfdrat8/FS19_Scarok4x4.zip.html';
    $postAuthor = 'North Modding Company';
    $postDate = 'September 23, 2020';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Meet the all new 2021 NMC Scarok<br>
          <br>
          The latest version of the iconic NMC Pickup Truck. Now available in the Scarok 1500, 2500, and 3500 editions.
          Completely resigned to meet the needs of today's farmer's and loggers and still looking amazing while getting
          the tough job's done.<br>
          <br>
          The NMC Scarok offers best in class towing capabilities. Offering both standard trailer hitch and goosneck
          attachment capabilities. Featuring multiple engine and wheel configurations including a dually configuration.
          Available on the 1500, 2500, and 3500 series truck's.<br>
          <br>
          The 2021 NMC Scarok 2500 and 3500 series truck's offer a detachable bed capability with numerous attachable
          bed
          options currently in production and will be available at your local NMC authorized dealer soon. All the while
          making sure that no truck can or will get the job done like the NMC line of pickup trucks.<br>
          <br>
          <br>
          Changelog 1.0.1.0:<br>
          -Now Support For Console<br>
          -Fixed Suspension For The Wheels<br>
          -Corrected The Mirrors<br>
          <br>
          Changelog 1.1.0.0:<br>
          -Now Has A Animated Tailgate<br>
          -Increased braking power<br>
          -Fixed reflections in mirror (outside cam)<br>
          -Rear view mirror adjusted<br>
          -Added pedals<br>
          -It should not clip thru ground anymore in shop on console<br>
          -Reduced price<br>
          -Fixed trailerLow attacher for standard attacher config<br>
          -Added German translations for all configurations
        </p>
