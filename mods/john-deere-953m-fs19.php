<!-- Keywords + SEO -->
<title>FS19 John Deere 953M - BestFSMods</title>
<meta name="description" content="Download the John Deere 953M FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 John Deere 953M - BestFSMods">
<meta name="twitter:description" content="Download the John Deere 953M FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/john-deere-953m.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 John Deere 953M - BestFSMods">
<meta property="og:description" content="Download the John Deere 953M FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/john-deere-953m.jpg">
<!------------------->
  ...
  <main role="main" class="container">
    ...
    <div class="center">
      <h1 class="h2 pb-4 mb-4 justify-content-center border-bottom text-align-center">
        John Deere 953M FS19
      </h1>
    </div>
    <div class="row justify-content-center">
      <p class="lead" style="font-size: 18px; margin-left: 10px; padding-right: 10px; border-right: 1px solid #dee2e6;">
        Author: North Modding</p>
      <p class="lead" style="font-size: 18px; margin-left: 10px; padding-right: 10px; border-right: 1px solid #dee2e6;">
        October 01, 2020</p>
      <p class="lead" style="font-size: 18px; margin-left: 10px; margin-right: 10px;"><a href="/categories/vehicles"
          style="text-decoration: none;">FS 19 vehicles</a></p>
    </div>
    <img src="../images/mod-images/john-deere-953m.jpg" alt="John Deere 953M FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 John Deere 953M Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          The John Deere 953M Swing Loader is a must have piece of equipment for any logging operation. It is capable of
          loading any size logs that your operation may be cutting. With its adjustable swing boom maneuvering tree
          length
          logs or cut to length timber is a breeze. The 953M has received an entirely new make over with redesigned cab
          interior, improved grapple size and strength, and an elevated cab option which raises the operator higher
          above
          the tracks and gives you the ability to manually tilt the cab as needed. It will also be available in a
          standard
          953 version which is a ridged frame that offers no manual tilt. Also new in this edition is improved engine
          sounds. Maintain your loading decks like never before with John Deere Power and technology.<br> <br> Peak
          Power:
          246 kW (330 hp) @ 1,900 rpm<br> Max. Speed: 3.6 km/h (2.2 mph)<br> Tractive Effort: 373 kN (83,880 lbf)<br>
          <br>
          Thanks to Ryan Kirkpatrick for helping us out with real life John Deere 959M Feller Buncher sounds.<br> <br>
          Changelog 2.0.0.0:<br> -Please sell old machine before updating this vehicle! Preferably start a new
          savegame!<br>
          -Model changes (model have gotten a total makeover)<br> -Added hoses<br> -Door will open when entering
          machine<br>
          -New displays<br> -New textures<br> -New XML file<br> -New icons<br> -New interior<br> -New decals (All decals
          made from scratch)<br> -Added leveling body (959M Swing Loader)<br> -Added custom engine sounds
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: North Modding</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/a6zd92bt7xxu/FS19_JohnDeere953MH_Swing.zip.html" target="_blank"><button
