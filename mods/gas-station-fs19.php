...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Gas Station';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/gas-station.jpg';
    $postCategory = 'buildings';
    $downloadLink = 'http://modsfile.com/d9wg20pj01hb/FS19_Gas_Station_Placeable.zip.html';
    $postAuthor = 'stefan1997';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          With this free placeable gas station you can refuel your vehicles directly at the Farm.<br>
          <br>
          Changelog V.1.0.0.1<br>
          -New Store and Modicon<br>
          -ModDesc version increased<br>
          -Ground texture changed from dirt to asphalt
        </p>
