<!-- Keywords + SEO -->
<title>FS19 Lone Oak Farm House - BestFSMods</title>
<meta name="description" content="Download the Lone Oak Farm House FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Lone Oak Farm House - BestFSMods">
<meta name="twitter:description" content="Download the Lone Oak Farm House FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/lone-oak-house.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Lone Oak Farm House - BestFSMods">
<meta property="og:description" content="Download the Lone Oak Farm House FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/lone-oak-house.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/lone-oak-house.jpg" alt="Lone Oak Farm House FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Lone Oak Farm House Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          The Lone Oak Farm House is now avalible for Everyone! Everything still functions just like on the map.<br>
          -Sleep
          Trigger is located in the Bedroom.<br> Price: 180,000
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: gForce_modding</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/hyelyqvoxds4/FS19_LoneOak_FarmHouse.zip.html" target="_blank"><button
