<!-- Keywords + SEO -->
<title>FS19 Kornau - BestFSMods</title>
<meta name="description" content="Download the Kornau FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Kornau - BestFSMods">
<meta name="twitter:description" content="Download the Kornau FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/kornau.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Kornau - BestFSMods">
<meta property="og:description" content="Download the Kornau FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/kornau.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/kornau.jpg" alt="Kornau FS19" class="img-fluid mx-auto d-block">
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome in the land of Kornau. Here you are in the land of the mountains. On the map you can be what you
          want.<br> On the map is all what you want:<br> -a lot of fields<br> -some valleys with many villages<br> -a
          big valley with small and big fields<br> -some farms for the mp<br> -some animated objects<br> -seasons
          ready<br> -animated traffic<br> -more terrain-angles<br> -foliage-change in winter<br> -snow-poles when
          it&acute;s snowing<br> -some selling Stations<br> -missions-System<br> -and much other<br> -127 farmlands to
          buy<br> -and much more
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: Suedtirol</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/we6v1c6i8wmq/FS19_Kornau.zip.html" target="_blank"><button
