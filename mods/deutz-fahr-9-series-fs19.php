...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Deutz-Fahr 9 Series';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/deutz-fahr-9.jpg';
    $postCategory = 'tractors';
    $downloadLink = 'http://modsfile.com/a33vkhuk0brl/FS19_DeutzFahr_Series9.zip.html';
    $postAuthor = 'blauea';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Deutz-Fahr 9 Series<br>
          -Base Price 246.000 &dollar;<br>
          -Engine Configurations<br>
          9290 TTV - 295 HP<br>
          9310 TTV - 312 HP<br>
          9340 TTV - 336 HP<br>
          9340 TTV WARRIOR - 336 HP<br>
          9340 TTV WARRIOR+ - 396 HP<br>
          -Tire Configurations<br>
          Trelleborg<br>
          Michelin<br>
          Mitas<br>
          Lizard<br>
          Nokian<br>
          <br>
          -Changelog 1.0.5.0<br>
          ModDesc version changed to 51.<br>
          Nokian tire brand added.<br>
