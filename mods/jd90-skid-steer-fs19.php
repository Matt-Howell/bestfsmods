...
<head>
  ...
  <?php 
    ...
    $postTitle = 'JD90 Skid Steer Loader';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/jd90-skid-steer.jpg';
    $postCategory = 'vehicles';
    $downloadLink = 'http://modsfile.com/6oyaigxvawxe/FS19_JD90.zip.html';
    $postAuthor = 'Blacksheep Modding';
