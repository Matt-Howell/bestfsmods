...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Case IH Farmlift 935';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/case-farmlift-935.jpg';
    $postCategory = 'vehicles';
    $downloadLink = 'http://modsfile.com/xmcx1i9xmqg8/FS19_CaseIH_Farmlift_935.zip.html';
    $postAuthor = 'Dales_farmer';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Case IH Farmlift 935<br>
          <br>
          4 Tyre brand configurations (Trelleborg, Nokian, Michelin and Mitas)<br>
          Openable door and window<br>
          Beacon light options<br>
          <br>
          Price: &pound;95955<br>
          Max. power: 1333 hp<br>
          Max. speed: 26 mph
        </p>
