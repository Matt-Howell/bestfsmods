<!-- Keywords + SEO -->
<title>FS19 Case IH Axial-Flow 7130 - BestFSMods</title>
<meta name="description" content="Download the Case IH Axial-Flow 7130 FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Case IH Axial-Flow 7130 - BestFSMods">
<meta name="twitter:description" content="Download the Case IH Axial-Flow 7130 FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/case-ih-axial-flow.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Case IH Axial-Flow 7130 - BestFSMods">
<meta property="og:description" content="Download the Case IH Axial-Flow 7130 FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/case-ih-axial-flow.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <div class="row justify-content-center">
      ...
      <p class="lead" style="font-size: 18px; margin-left: 10px; padding-right: 10px; border-right: 1px solid #dee2e6;">
        October 07, 2020</p>
      <p class="lead" style="font-size: 18px; margin-left: 10px; margin-right: 10px;"><a href="/categories/combines"
          style="text-decoration: none;">FS 19 combines</a></p>
    </div>
    <img src="../images/mod-images/case-ih-axial-flow.jpg" alt="Case IH Axial-Flow 7130 FS19"
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Case IH Axial-Flow 7130 Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Case IH Axial-Flow 7130:<br> <br> Price: 310.000 &euro;<br> Power: 415 HP<br> Capacity: 10570 l<br> <br> Case
          IH
          3020 35FT:<br> <br> Price: 46.000 &euro;<br> Max. working speed: 10 kph<br> Working width: 10.5 m
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: Matt26</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/rfgo9hmjov0l/FS19_caseIHAxialFlow7130pack.zip.html" target="_blank"><button
