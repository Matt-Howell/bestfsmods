<!-- Keywords + SEO -->
<title>FS19 Greenwich Valley - BestFSMods</title>
<meta name="description" content="Download the Greenwich Valley FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Greenwich Valley - BestFSMods">
<meta name="twitter:description" content="Download the Greenwich Valley FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/greenwich-valley.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Greenwich Valley - BestFSMods">
<meta property="og:description" content="Download the Greenwich Valley FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/greenwich-valley.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/greenwich-valley.jpg" alt="Greenwich Valley FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Greenwich Valley Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome to the sunny countryside of Greenwich. This map is completely fictional and nothing is based of a real
          place.<br> <br> Sleep Triggers are located in the house at the grain farm. There is also a working TV and a
          radio
          in the house. lime can be Purchased from the BGA or R.K Blair farm supplier.<br> <br> Features<br> - 4
          Detailed
          Towns<br> - Multi terrain angle<br> - 7 Buy-able yards<br> - Built in cows, pigs, sheep and horses<br> - 125
          fields<br> - 7 sell points<br> <br> A new Save will need to be created for all the new yards to work
          correctly.<br> <br> Changelog 1.1.0.0<br> -----------------------------------<br> - Redesigned cow, sheep and
          storage yards<br> - Added Season Support<br> - Fixed gates for Competitive Farming<br> - Sell-able House and
          Grain
          silo<br> - New resigned Wind Turbines<br> - Added second BGA
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: GreenBale</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/uoagrtpbwbih/fs19_greenwich.zip.html" target="_blank"><button
