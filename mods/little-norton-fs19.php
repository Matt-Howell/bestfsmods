...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Little Norton';
    $postDesc = 'Download the '.$postTitle.' FS 19 map here!';
    $postImg = '/images/mod-images/little-norton-1.jpg';
    $postCategory = 'maps';
    $downloadLink = 'http://modsfile.com/ehyniwstgal1/FS19_LittleNorton.zip.html';
    $postAuthor = 'GBModding';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome To Little Norton this is a fictional based english map.
          <br><br>
          - All animals are built into as placeables<br>
          - full seasons support with grazing<br>
          - Custom lighting<br>
          - Animated objects<br>
          - This map includes all Farming Simulator 19 features.<br>
          - Over 50 fields small/medium/large and large forestry areas.<br>
          - Custom transport missions and field missions.<br>
          - Please ask before using any of the models and textures that are in this map.<br>
          - Credits to Lancyboi,Shy Wizard and Oxygen David, Without them this would not of been possible.
        </p>
