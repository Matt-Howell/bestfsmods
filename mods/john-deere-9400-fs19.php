...
<head>
  ...
  <?php 
    ...
    $postTitle = 'John Deere 9400 - 9500';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/john-deere-9400.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/p1491ijfocup/FS19_JohnDeere_9400_9500.zip.html';
    $postAuthor = 'SiiD Modding';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          John Deere 9400 - 9510 North America<br>
          <br>
          Price: 61.500 &euro;<br>
          Power: 185HP - 240HP<br>
          Capacity: 9830l<br>
          <br>
          Animation:<br>
          harvester shaking during work<br>
          all elements move during work
        </p>
