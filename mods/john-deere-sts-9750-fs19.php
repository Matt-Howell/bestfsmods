...
<head>
  ...
  <?php 
    ...
    $postTitle = 'JOHN DEERE STS 9750';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/john-deere-9750.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/185xhbvyij4a/FS19_JohnDeereSTS9750.zip.html';
    $postAuthor = 'CONNECT MODDING';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          The John Deere STS system was designed to meet the demand for high productivity with maximum grain
          quality.<br>
          These harvesters provide the producer with the best and most refined set of cut, feed, track, separation
          and<br>
          cleaning ever seen on the market. John Deere STS combines combine high harvest speed with low loss rates and
          excellent<br>
          grain quality, thus guaranteeing maximum yield and profitability in the harvest.<br>
          <br>
          We have in this modification the following items:<br>
          <br>
          John Deere STS 9750<br>
          - price: 137000<br>
          - power: 325 PS<br>
          - speed: 25 KM/H<br>
          - grain tank capacity: 10570 litres<br>
          - multiple tire configurations<br>
          - option of headlights with cover model 2003 and 2006<br>
          - Rotation of pulleys and machine parts working<br>
          - Animation of joystick, seat damper, pedals, and steering wheel<br>
          <br>
          John Deere 630F<br>
          - price: 4280<br>
          - working width: 9.7 metres<br>
          - speed limit: 10 KM/H<br>
