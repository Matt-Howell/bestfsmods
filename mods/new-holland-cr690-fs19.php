...
<head>
  ...
  <?php 
    ...
    $postTitle = 'New Holland CR 6.90';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/new-holland-cr690.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/2pg7h1p31x09/FS19_NH_CR_6_7_8_9_90_UniversalPassenger.zip.html';
    $postAuthor = 'Rick Black Labele TWD';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          The New Holland Cr 6.90 offers you a variety in this design.<br><br>
          -Price: 228.000, - &euro;<br>
          -Working speed: 12 km / h<br>
          -Speed: 40 km / h<br>
          -Power: 227 hp - 531 hp<br>
          -Volume: 11,500 liters<br>
          -Animated door to open by mouse control<br>
          -GPS preparation (GPS can be configured with associated script)<br>
          -UniversalPassenger Prepared<br>
          -4 tire configuration + color choice<br>
          -3 Style configurations<br>
          <br>
          Changelog 1.0.1.1:<br>
          Fixed decals of version<br>
          Discharge tube light added<br>
          Moddesc Version 47
        </p>
