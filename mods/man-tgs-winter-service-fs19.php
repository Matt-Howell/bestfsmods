...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Man TGS Winter Service';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/man-winter-service-1.jpg';
    $postCategory = 'trucks';
    $downloadLink = 'http://modsfile.com/i2e3i567ua2x/FS19_ManTGS_WinterService.zip.html';
    $postAuthor = 'blauea';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          ...
          Power: 500 HP
          <br><br>
          *Scripts in this mod made by Realismus Modding. Huge Thanks!
          <br><br>
          -Changelog 1.0.1.0
          <br>
          Mod and store icons have changed.
          <br>
          All tracks option added.
        </p>
