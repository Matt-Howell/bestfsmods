...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Simple Fueling Station';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/simple-fueling-station.jpg';
    $postCategory = 'buildings';
    $downloadLink = 'http://modsfile.com/uaasu7ggvz8e/FS19_simpleFuel_station.zip.html';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          This Simple Fueling Station is great for farms of all sizes. The small footprint allows it to be placed almost
          anywhere.<br>
          Fuel is sold at a 10% discount at this fill station.<br>
          Price: &dollar;6000<br>
          Changelog 1.1.0.0:<br>
          - Added black color option.<br>
          - Small adjustments
        </p>
