...
<head>
  ...
  <?php 
    ...
    $postTitle = 'New Holland CR5080';
    $postDesc = 'Download the'.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/new-holland-cr5080-1.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/71eh6siezu3b/FS19_NewHolland_CR5080.zip.html';
    $postAuthor = 'Agro Tonho';
