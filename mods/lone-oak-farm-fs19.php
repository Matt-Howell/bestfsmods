...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Lone Oak Farm';
    $postDesc = 'Download the '.$postTitle.' FS 19 map here!';
    $postImg = '/images/mod-images/lone-oak-1.jpg';
    $postCategory = 'maps';
    $downloadLink = 'http://modsfile.com/as2bbma0o11a/FS19_Loneoak.zip.html';
    $postAuthor = 'Map creater Bulletbill83/Converter Oxygendavid';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          ...
          <br><br>
          - Full seasons support with many extra features<br>
          - New grass textures (cut grass texture etc)<br>
          - Custom ground textures<br>
          - Custom Wheat/barley textures (other forgotten fruits)<br>
          - 55 fields with many missions<br>
          - 3 sell points Bga,sawmill and other places<br>
