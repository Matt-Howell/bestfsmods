...
<head>
  ...
  <?php 
    ...
    $postTitle = 'JCB 435S Wheel Loader';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/jcb-435s.jpg';
    $postCategory = 'vehicles';
    $downloadLink = 'http://modsfile.com/fakszk53eswy/FS19_jcb435sT4F.zip.html';
    $postAuthor = 'RedCat3D, Pixeldesign';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          JCB 435S Agri Tier4-Final 2018 and Tier5 2019.<br>
          <br>
          The JCB Wheelloader 435S is made for maximum productivity in farming operations. The 435S only comes with high
          quality components like Cummins-Engine, ZF-Transmission and -Axles and Rexroth-Pumps for best power to weight
          ratio as well as excellent longevity.<br>
          Also its very safely, easy to maintain and with Eco-Mode as well as automatic neutral-circuit most
          fuel-efficient.<br>
          <br>
          Preis: 184.000$<br>
          Power:<br>
          Stage IV: 172kw/235hp<br>
          Stage V: 185kw/252hp<br>
          Diesel: 400l<br>
          DEF: 40l<br>
          <br>
          -Changelog-<br>
          1.0.0.1<br>
          *Fixed Trelleborg Twin-Wheel Config<br>
          1.1.0.0<br>
          *Door now able to open with simpleIC (PC)<br>
          *Fixed wrong material on seat backside<br>
          *Fixed steeringwheel snipping on first steer<br>
          *Fixed clipping fail with cuffs on some perspective<br>
          *Added Michelin XHA2 Communal Tires<br>
