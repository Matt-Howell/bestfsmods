...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Case IH Autonomous';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/case-autonomous.jpg';
    $postCategory = 'tractors';
    $downloadLink = 'http://modsfile.com/iaz4lcxjuxek/FS19_autonomousCaseIH.zip.html';
    $postAuthor = 'SimulagriModding';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Revealed to the world in 2016, the autonomous Magnum is a technological showcase, a concept devoid of piloting
          space which foreshadows the future of agricultural robotization.<br>
