...
<!-- Keywords + SEO -->
<title>FS19 Homestead Economy - BestFSMods</title>
<meta name="description" content="Download the Homestead Economy FS 19 mod here!">
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Homestead Economy - BestFSMods">
<meta name="twitter:description" content="Download the Homestead Economy FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/homestead.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Homestead Economy - BestFSMods">
<meta property="og:description" content="Download the Homestead Economy FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/homestead.jpg">
<!------------------->
  ...
  <main role="main" class="container">
    ...
    <div class="row justify-content-center">
      ...
      <p class="lead" style="font-size: 18px; margin-left: 10px; margin-right: 10px;"><a
          href="/categories/maps" style="text-decoration: none;">FS 19 maps</a></p>
    </div>
    <img src="../images/mod-images/homestead.jpg" alt="Homestead Economy FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Homestead Economy Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome to the Homestead Economy map!<br> What the map offer:<br> - 54 field, 3 meadows<br> - BGA<br> - Farm silo<br> - Small forest<br> - Mission system<br> - Animal stables: Sheep, pig, cow, chicken<br> - Seasons ready<br> <br> 1.0.0.1<br> - Console release<br> - Collisions added to storage wall<br> - l10n missing fix<br> - New BGA subtitle<br> - New collision added to cow and pig stables
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: Zoli708</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/ep831attuvto/FS19_Homestead_Economy.zip.html" target="_blank"><button class="btn btn-primary btn-lg mx-auto border-0"
