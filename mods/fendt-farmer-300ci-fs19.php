...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Fendt Farmer 300Ci';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/fendt-farmer-300ci.jpg';
    $postCategory = 'tractors';
    $downloadLink = 'http://modsfile.com/2px595pxh72z/FS19_FendtFarmer300Ci.zip.html';
    $postAuthor = 'Cayman';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Fendt Farmer 300Ci<br>
          <br>
          Price: 56.200&euro;<br>
          Power: 80-105HP<br>
          <br>
          - all FS19 Functions<br>
          - animated and illuminated interior<br>
          - front linkage configuration<br>
          - GPS configuration<br>
          - doors and windows can be opened with SimpleIC<br>
          - beaconlight and warning signs configurable and foldable from the outside with SimpleIC<br>
          - front fenders can be removed from the outside with SimpleIC<br>
          - with Ctrl + F you can switch between normal light and top spotlights<br>
          - RMT installed<br>
          <br>
          SimpleIC, RMT from Modelleicher and GPS from Wopster are required for the full range of functions!
        </p>
