<!-- Keywords + SEO -->
<title>FS19 Lawfolds - BestFSMods</title>
<meta name="description" content="Download the Lawfolds FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Lawfolds - BestFSMods">
<meta name="twitter:description" content="Download the Lawfolds FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/lawfolds-19.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Lawfolds - BestFSMods">
<meta property="og:description" content="Download the Lawfolds FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/lawfolds-19.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/lawfolds-19.jpg" alt="Lawfolds FS19" class="img-fluid mx-auto d-block">
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Lawfolds is based around a real working farm in the fertile rolling hills of Grampian, Scotland. There are two
          additional farms, East Law where the sheep can be found, and Newton of Lewesk is where the Cows are located.
          This map features:-<br> <br> - Three Working Farms, two which have independent Grain Silos. Three Forestry
          Areas around the map.<br> - Four Different Sell Points (Aberdeen Grains, Highland Grains, Aberdeen Northern
          Marts Group and Housing Estate) for the various crops.<br> - High Capacity Storage at Highland Grains so you
          can store those crops waiting for free of charge.<br> - Seed and Fertiliser points on the Farms and at two
          sell points, as well as storage for the pallets on the farms for those who prefer to use them.<br> - Prices
          have been increased slightly higher than base game. Missions on all fields not owned, to help get those prices
          down.<br> - Please be aware all hedges, fences and walls have collisions, however there are sizeable grass
          headlands around the fields to help those workers out.<br> - Animated Gates and Lights to most of the Farm
          Buildings. Automatic Lights at the sell points.
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: CMMODZ</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/7w4ey5yilcio/FS19_LAWFOLDS.zip.html" target="_blank"><button
