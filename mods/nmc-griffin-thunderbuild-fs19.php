...
<head>
  ...
  <?php 
    ...
    $postTitle = 'NMC Griffin Thunderbuild';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/nmc-griffin-thunderbuild.jpg';
    $postCategory = 'trucks';
    $downloadLink = 'http://modsfile.com/jludzpdi7zrl/FS19_NMC_Griffin_Thunderbuild_UniversalPassenger.zip.html';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          The Griffin Thunderbuild is a purpose built truck for moving forest machines. With a short wheelbase and the
          ability to lift the rear trailer it makes it a compact and ideal transport solution for the forest. Tons of
          options for cab decorations, bullbars and lights to make sure its the king of the road.<br>
          <br>
          Griffin Truck:<br>
          -Price: 260000$<br>
          -Top speed: 83km/h<br>
          -Horse power: 520-730 hp<br>
          -Engine configurations<br>
          -Front 3 point (in config)<br>
          -Wheel Configurations<br>
          -Design Configurations<br>
          -Base color config<br>
          -Design color config<br>
          -Rim color config<br>
          -Tension belt support<br>
