...
<head>
  ...
  <?php 
    ...
    $postImg = '/images/mod-images/cybuchowo-1.jpg';
    $postCategory = 'maps';
    $downloadLink = 'https://modsbase.com/9pedgimri9bq/FS19_Cybuchowo.zip.html';
    $postAuthor = 'zielak04';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome to Cybuchowo!<br><br>
          On the map you will find:<br>
          - 206 fields (each bought separately)<br>
          - several forests<br>
          - several purchases<br>
          - three new crops (alfalfa, rye, triticale)<br>
          - two new types of animals: goats and ducks (Huge thanks to Farmer_Andy, the author of the map Hof Bergmann
          for
          granting permission to use these animals on the map)<br>
          - Full compatibility with seasons<br>
          - slightly changed weeds<br>
          - slightly changed weather conditions<br>
          - two new types of trees for planting (spruce and fir)<br>
          <br>
          Goats produce a new type of milk that accepts a tank that is available in the store<br>
          If you want to play strawHarvest DLC, maize+ or other mods which adds new fruits/filltypes on this map, you
          must
          play without seasons, because the map does not work with seasons has a limit for fruits<br>
          <br>
          Changelog 1.0.0.1:<br>
          -Some farmlands improvements<br>
          -Some textures changes<br>
          -Removed tank and ball<br>
          -Removed levitating mover<br>
          -Some map ending improvements<br>
          -Added male ducks so now there is a possibility for multiplying ducks<br>
          <br>
          Have a nice game!
        </p>
