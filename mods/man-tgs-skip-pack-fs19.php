<!-- Keywords + SEO -->
<title>FS19 MAN TGS Skip Pack - BestFSMods</title>
<meta name="description" content="Download the MAN TGS Skip Pack FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 MAN TGS Skip Pack - BestFSMods">
<meta name="twitter:description" content="Download the MAN TGS Skip Pack FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/man-tgs-skip-pack.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 MAN TGS Skip Pack - BestFSMods">
<meta property="og:description" content="Download the MAN TGS Skip Pack FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/man-tgs-skip-pack.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/man-tgs-skip-pack.jpg" alt="MAN TGS Skip Pack FS19"
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 MAN TGS Skip Pack Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          MAN TGS 18.500 4x4 Truck with skip mechanism.<br> <br> Price: 130000 &euro;<br> Power: 500 hp<br> <br> Lizard
          Skip
          Container<br> <br> Price: 1850 &euro;<br> Capacity: 6000L<br> <br> ChangeLog 1.1.0.0:<br> -Added color
          configuration to container<br> -Fixed various bugs
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: kotsiossp97</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/f4olplwjkr5m/FS19_TGS18500Skip_console.zip.html" target="_blank"><button
