...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Massey Ferguson 7700S';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/massey-ferguson-7700s.jpg';
    $postCategory = 'tractors';
    $downloadLink = 'http://modsfile.com/9upgimmetrwo/FS19_MasseyFerguson7700S.zip.html';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Price: 176000 &euro;<br>
          Power: 210-280hp<br>
          Design Color Configurations<br>
          -Update 1.1.0.0<br>
          -New Colors Design<br>
          ...
          -New Skin Lights<br>
          -New Details<br>
          -New Tires Configurations<br>
          -Update 1.2.1.0<br>
          -New Skin front Lights<br>
          -Wheels fix<br>
          -New Daylights function<br>
          -New Colors Design<br>
          -New Interior Design<br>
          -Joystick Animated and Doors
        </p>
