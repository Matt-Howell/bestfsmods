...
<head>
  ...
  <?php 
    ...
    $postTitle = 'New Holland CR9.90';
    $postDesc = 'Download the'.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/new-holland-cr990.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/uqmcqqblihjf/FS19_NewHollandCR990.zip.html';
    $postAuthor = 'STv-Modding';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Price: 372.000&euro;<br>
          Power: Motor by FPT Cursor 13-12.9L , 571 HP /420 KW<br>
          Capacity: 10200 l<br>
          -Animated Doors and Interior Parts<br>
          -Real dynamic back axle<br>
          -Various Tires Option Trelleborg,Michelin<br>
          -Design Yellow Bull and Tiger<br>
          -Tank Design<br>
          -Pipe Design
        </p>
