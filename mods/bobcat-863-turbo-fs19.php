...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Bobcat 863 Turbo';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/bobcat-863-turbo.jpg';
    $postCategory = 'vehicles';
    $downloadLink = 'http://modsfile.com/37mklvipz5jp/FS19_Bobcat863Pack.zip.html';
    $postAuthor = 'ARM-Team';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Bobcat 863 Turbo High Flow with Bobcat shovel.<br>
          <br>
          Features:<br>
          - Horsepower: 74 HP<br>
          - Wheels configurations<br>
          - Windows configurations<br>
          - Beacon configurations<br>
          - Bobcat<br>
          Price: 25000 &euro;<br>
          - Shovel<br>
          Capacity: 2000 l<br>
