<!-- Keywords + SEO -->
<title>FS19 GreenRiver2019 - BestFSMods</title>
<meta name="description" content="Download the GreenRiver2019 FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 GreenRiver2019 - BestFSMods">
<meta name="twitter:description" content="Download the GreenRiver2019 FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/green-river-1.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 GreenRiver2019 - BestFSMods">
<meta property="og:description" content="Download the GreenRiver2019 FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/green-river-1.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <img src="../images/mod-images/green-river-1.jpg" alt="GreenRiver2019 FS19" class="img-fluid mx-auto d-block">
    <div class="center">
      <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
        FS19 GreenRiver2019 Mod
      </h2>
    </div>
    <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
      Welcome to the GreenRiver 2019!<br> Due to the success of the GreenRiver map in Farming Simulator 17 thanks to all
      of you Bart decided to bring the map to Farming Simulator 19.<br> In the GreenRiver map you can decide what you
      want to do.<br> There are more than 160 acres of fields, you can take care of the animals, be an agricultural
      farmer or you can go out to the forestry part of the map, field missions, it's all up to you!<br> <br> Changelog
      1.0.1.0:<br> - New savegame recommended<br> - Fixed field 26 angle area<br> - Fixed BGA trigger<br> - Fixed BGA
      tipCollision<br> - Fixed waterFillTriggers<br> - Fixed lights Machineshed 3 doors<br> - Fixed foodSpillage all
      animals<br> - Improved woolPallet spawner<br> - Improved shopTrigger location<br> - Improved light trigger
      CowStall<br> - Silo storage increased
    </p>
    <div class="center" style="margin-top: 15px">
      <p class="lead mx-auto">Credit: Bart - NLD</p>
    </div>
    <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
      <!-- ad was here -->
    </div>
    <div class="center">
      <a href="http://modsfile.com/zio1h1vhv8jp/fs19_greenriver2019.zip.html" target="_blank"><button
