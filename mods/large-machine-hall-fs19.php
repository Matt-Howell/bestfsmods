...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Large Machine Hall';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/large-machine-hall.jpg';
    $postCategory = 'buildings';
    $downloadLink = 'http://modsfile.com/mgj0iy2aycrx/FS19_largeMachineHall.zip.html';
    $postAuthor = 'Neroxc';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          This is a large machine hall with 5 gates and animated light.<br>
          -Price: 43.500 &euro;<br>
          -Daily maintenance: &euro; 65<br>
          <br>
          Changelog 1.1.0.0<br>
          -faulty lighting system was adjusted<br>
          -Add other decoration<br>
          -l10n texts were adjusted<br>
          -Steel beam adjusted<br>
          <br>
          The light switch for the outside lighting is located on the main page of the hall (next to the door)!
        </p>
