...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Fendt 9490 X';
    $postDesc = 'Download the'.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/fendt-9490-x.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/mbmzlns24nki/FS19_Fendt9490X.zip.html';
    $postAuthor = 'Gefd25';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Fendt 9490 X:<br>
          <br>
          Price: 285,000 &euro;<br>
          Power: 496 hp (365 kW)<br>
          Capacity: 12,500 l<br>
          Unloading rate: 120 l/s<br>
          Type: Hybrid combine<br>
          <br>
          Openable doors<br>
          <br>
          Configuration:<br>
          Wheels incl. crawlers<br>
          Color<br>
          <br>
          <br>
          Fendt PowerFlow 35FT:<br>
          <br>
          Price: 51,000 &euro;<br>
          Working width: 10.7 m<br>
          Max. working speed: 10 kph<br>
          <br>
          Configuration:<br>
          Color
        </p>
