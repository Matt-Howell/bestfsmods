<!-- Keywords + SEO -->
<title>FS19 CLAAS Xerion 3000 - BestFSMods</title>
<meta name="description" content="Download the CLAAS Xerion 3000 FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 CLAAS Xerion 3000 - BestFSMods">
<meta name="twitter:description" content="Download the CLAAS Xerion 3000 FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/claas-xerion.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 CLAAS Xerion 3000 - BestFSMods">
<meta property="og:description" content="Download the CLAAS Xerion 3000 FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/claas-xerion.jpg">
<!------------------->
...
<body style="font-family: Open Sans, sans-serif;">
  ...
  <main role="main" class="container">
    ...
    <div class="row justify-content-center">
      ...
      <p class="lead" style="font-size: 18px; margin-left: 10px; padding-right: 10px; border-right: 1px solid #dee2e6;">
        October 01, 2020</p>
      <p class="lead" style="font-size: 18px; margin-left: 10px; margin-right: 10px;"><a href="/categories/tractors"
          style="text-decoration: none;">FS 19 tractors</a></p>
    </div>
    <img src="../images/mod-images/claas-xerion.jpg" alt="CLAAS Xerion 3000 FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 CLAAS Xerion 3000 Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Manufacturer: CLAAS<br> Model: 3000 Trac VC<br> Production: 2007 - 2013<br> Standard engine: Caterpillar C9
          six
          cylinder turbo, 8,8 litres<br> Powershift gear: ZF Eccom 3.5 CVT<br> Max speed: 50 km/h<br> <br> Price: 330200
          &euro;<br> Power: 335 - 379HP<br> Upgrade: wheel brand, wheel, body color, rim color, engine grid color, front
          attacher configuration, mudguards, side sign<br> <br> Shop Category: Large Tractors<br> <br> Mod supported :
          Simple IC, Guidance Steering (PC only)
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: Smety</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/zp3g1fbo9wi4/FS19_CLAAS_Xerion_3000_series.zip.html" target="_blank"><button
