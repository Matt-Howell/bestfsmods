...
<head>
  ...
  <?php 
    ...
    $postTitle = 'John Deere 6R Series';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/john-deere-6r-1.jpg';
    $postCategory = 'tractors';
    $downloadLink = 'http://modsfile.com/z9aqgabr4kjy/FS19_JohnDeere_6R.zip.html';
    $postAuthor = 'blauea';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          ...
          New details added.
          <br>
          Toolbox option added.
          <br>
          Wheel weights changed.
        </p>
