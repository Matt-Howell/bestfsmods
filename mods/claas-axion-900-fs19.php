...
<head>
  ...
  <?php 
    ...
    $postTitle = 'CLAAS Axion 900';
    $postDesc = 'Download the '.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/claas-axion-900.jpg';
    $postCategory = 'tractors';
    $downloadLink = 'http://modsfile.com/c3xk4afwqk7h/FS19_CLAAS_Axion_900.zip.html';
    $postAuthor = 'Smety';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Manufacturer: CLAAS<br>
          Model: Axion 900 series<br>
          Production: 2011 -<br>
          Standard engine: Iveco / FPT Cursor 9, Tier 4i<br>
          Powershift gear: CMATIC - ZF - ECCOM 3.0<br>
          Max speed: 50 km/h<br>
          <br>
          Price: 263000 &euro;<br>
          Power: 320 - 445HP<br>
          Upgrade: wheel brand, wheel, body color, rim color, hood grid color, exhaust cover<br>
          <br>
          Changelog 1.5.0.0<br>
          - fixed some textures<br>
          - weight, power<br>
          - fixed some textures<br>
          <br>
          Mod supported : Simple IC, Guidance Steering (PC only)
        </p>
