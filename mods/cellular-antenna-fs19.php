<!-- Keywords + SEO -->
<title>FS19 Cellular Antenna - BestFSMods</title>
<meta name="description" content="Download the Cellular Antenna FS 19 mod here!">
<meta name="keywords"
...
<!-- Social Media -->
<meta name="twitter:title" content="FS19 Cellular Antenna - BestFSMods">
<meta name="twitter:description" content="Download the Cellular Antenna FS 19 mod here!">
<meta name="twitter:image" content="../images/mod-images/cellular-antenna.jpg">
<meta name="twitter:card" content="summary_large_image">

<meta property="og:title" content="FS19 Cellular Antenna - BestFSMods">
<meta property="og:description" content="Download the Cellular Antenna FS 19 mod here!">
<meta property="og:image" content="../images/mod-images/cellular-antenna.jpg">
<!------------------->
  ...
  <main role="main" class="container">
    ...
    <div class="center">
      <h1 class="h2 pb-4 mb-4 justify-content-center border-bottom text-align-center">
        Cellular Antenna FS19
      </h1>
    </div>
    <div class="row justify-content-center">
      <p class="lead" style="font-size: 18px; margin-left: 10px; padding-right: 10px; border-right: 1px solid #dee2e6;">
        Author: DD ModPassion</p>
      <p class="lead" style="font-size: 18px; margin-left: 10px; padding-right: 10px; border-right: 1px solid #dee2e6;">
        October 01, 2020</p>
      <p class="lead" style="font-size: 18px; margin-left: 10px; margin-right: 10px;"><a href="/categories/buildings"
          style="text-decoration: none;">FS 19 buildings</a></p>
    </div>
    <img src="../images/mod-images/cellular-antenna.jpg" alt="Cellular Antenna FS19" class="img-fluid mx-auto d-block">
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <div class="center">
          <h2 class="h4 pb-4 mb-4 mt-4 justify-content-center border-bottom text-align-center">
            FS19 Cellular Antenna Mod
          </h2>
        </div>
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Place this on your farm to receive subsidies from mobile operators.<br> <br> Price: 1.000 &euro;<br> Income
          per
          hour:<br> Easy: 20 &euro;<br> Normal: 15 &euro;<br> Hard: 10 &euro;<br> Maintenance: 4 &euro; / day
        </p>
        <div class="center" style="margin-top: 15px">
          <p class="lead mx-auto">Credit: DD ModPassion</p>
        </div>
        <div style="margin: auto; margin-top: 15px; margin-bottom: 10px;">
<!-- ad was here -->
        </div>
        <div class="center">
          <a href="http://modsfile.com/wmor75kooo4b/FS19_cellularAntenna.zip.html" target="_blank"><button
