...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Lubelska Dolina';
    $postDesc = 'Download the '.$postTitle.' FS 19 map here!';
    $postImg = '/images/mod-images/lubelska-dolina-1.jpg';
    $postCategory = 'maps';
    $downloadLink = 'http://modsfile.com/7v637lwro7a8/FS19_LubelskaDolina.zip.html';
    $postAuthor = 'Rajot GPLAY';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Welcome to Lubelska Dolina! This map is set in the east of Poland and more specifically in the Lublin region.
          This is a very extensive version of the map from FS17.
          <br><br>
          The map has: <br>
          - 5 farms (cows, sheep, chickens, pigs and horses)<br>
          - Almost 190 fields (including meadows)<br>
          - 4 selling points<br>
          - Sugar factory (selling point beets and potatoes)<br>
          - Biogas plant<br>
          - Sawmill<br>
          - A huge forest<br>
          - Hilly terrain<br>
          - Missions on the fields<br>
          - New crop textures<br>
          - Animated door and light<br>
        </p>
