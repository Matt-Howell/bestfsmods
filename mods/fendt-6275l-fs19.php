...
<head>
  ...
  <?php 
    ...
    $postTitle = 'Fendt 6275L';
    $postDesc = 'Download the'.$postTitle.' FS 19 mod here!';
    $postImg = '/images/mod-images/fendt-6275l.jpg';
    $postCategory = 'combines';
    $downloadLink = 'http://modsfile.com/vazblz67jhen/FS19_fendt6275L.zip.html';
    $postAuthor = 'E.T.A La Marchoise';
...
<!-- ad was here -->
      ...
      <div class="col-md-9 mr-0 border-left mb-4">
        ...
        <p class="text-align-left" style="padding-left: 3%; padding-right: 3%">
          Fendt combine harvester<br>
          Brand : Fendt<br>
          Price : 220 000 &euro;<br>
          Capacity : 8600L<br>
          <br>
          Fendt FreeFlow Cutter<br>
          Work width : 7.6m<br>
          Price : 49 500 &euro;<br>
          <br>
          Changelog 1.1.0.0 :<br>
          - Change motor configuration name<br>
          - Change spec power to 276hp<br>
          - New &quot;cinema&quot; camera<br>
          - New front sides lights<br>
          - New dashboard decals<br>
          - New pipe light<br>
          - Add camera at the end of pipe<br>
          - Change default back lights to LED lights
        </p>
