...
<head>
  <!-- Keywords + SEO -->
  <title>About Us - BestFSMods</title>
	<meta name="description" content="Learn more about BestFSMods here!">
  <link rel="shortcut icon" type="image/png" href="/favicon.png">
  <link rel="canonical" href="https://bestfsmods.com/about" />
  ...
  <!-- Social Media -->
  <meta name="twitter:title" content="About Us - BestFSMods">
	<meta name="twitter:description" content="Learn more about BestFSMods here!">
	<meta name="twitter:image" content="/images/icon-cover-184.png">
  <meta name="twitter:card" content="summary_large_image">
        
	<meta property="og:title" content="About Us - BestFSMods">
	<meta property="og:description" content="Learn more about BestFSMods here!">
...
<div class="container" style="margin-top: 75px; padding: 0;">        
  <div class="jumbotron text-white rounded" style="padding: 0; min-height: 200px;">
    ...
    <p>
        Welcome to BestFSMods, your number one source for all FS 19 mods, maps and more! We are dedicated to providing you the very best FS 19 mods, with an emphasis on maps, tractors and trucks.
        <br><br>
        Founded in August 2020, BestFSMods has come a long way from its beginnings and we have added a lot of mods! We started BestFSMods because we got bored of playing with vanilla FS 19, we wanted an aspect of community created content! That is why we made our site! We aim to be the No.1 place for all FS 19 mods!
        <br><br>
        We hope you enjoy the mods as much as we enjoy offering them to you. If you have any questions or comments, please do not hesitate to <a href="contact">contact us</a>.
        <br><br>
        Enjoy,
        <br>
        BestFSMods
        
        <div class="row" style="justify-content: center; min-width: 50px; min-height: 50px; align-items: center; margin-top: 3%; margin-bottom: 3%;">
            <a href="https://instagram.com/bestfsmods.ig/" class="fab fa-instagram" id="instagram2"></a>
            <a href="https://twitter.com/bestfsmods/" class="fab fa-twitter" id="instagram2" style="background:#55ACEE"></a>
        </div>
    </p>
